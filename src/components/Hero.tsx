    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-secondary-foreground/80">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium">{t('hero.callUs')}</p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium">{t('hero.email')}</p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium">{t('hero.serviceAreas')}</p>
                  <p className="text-sm">{t('hero.serviceAreasText')}</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-10 animate-bounce">
        <div className="text-center text-secondary-foreground/60">
          <p className="text-sm mb-2">{t('hero.scrollForServices')}</p>
